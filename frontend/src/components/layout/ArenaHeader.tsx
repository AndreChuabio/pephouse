  ...
  return (
    <header className="h-16 flex items-center justify-between px-8 border-b border-zinc-800/60 shrink-0 z-10 bg-zinc-950/80 backdrop-blur-md">
      <div className="flex items-center gap-4">
        <h1 className="text-lg font-semibold tracking-tight text-white">Arena Console</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          type="button"
          className="bg-white text-zinc-950 hover:bg-zinc-200 transition-colors text-sm font-medium px-4 py-1.5 rounded-md shadow-sm"
        >
          Run Simulation
        </button>
      </div>
