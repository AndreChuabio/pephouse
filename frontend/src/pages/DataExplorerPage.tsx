                  ...
                  <Section icon="solar:diagram-up-linear" title="Synthea modules" count={detail.modules.length}>
                    <div className="space-y-2">
                      {detail.modules.map((m) => {
                        ...
                        return (
                          <div key={m.id} className="bg-zinc-950/50 rounded border border-zinc-800/60">
                            <button
                              type="button"
                              onClick={() => toggle(k)}
                              className="w-full flex items-center justify-between gap-3 px-3 py-2 hover:bg-zinc-900/60 rounded text-left"
                            >
                              <span className="flex items-center gap-2 min-w-0 flex-1">
                                ...
                                <span className="min-w-0">
                                  <span className="block text-sm text-zinc-200 truncate">{m.name}</span>
